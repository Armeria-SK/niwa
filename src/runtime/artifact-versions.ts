...
export class ArtifactVersions {
 ...
 inspect(actor:Actor,id:string) {
  ...
  return {...item,...meta,sha256,file:file??null,versions:versions.length?versions:[{id,name:item.name,author_id:item.author_id,created_at:item.created_at,version:1,frozen:0}],reviews,referenced_by};
 }
