...
export const kindLabel = kind => ({research_and_execution_plan:'調査・実行計画',research_memo:'調査メモ',research:'調査',report:'報告書',plan:'計画',memo:'メモ',code:'コード',markdown:'文書',text:'テキスト',document:'文書',manifest:'ファイル一覧',file:'ファイル'})[kind] || 'その他の資料';
