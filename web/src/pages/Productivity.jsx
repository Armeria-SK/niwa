...
export function ArtifactLibrary({ onDelete, artifacts, members, onOpen, onThread }) {
  ...
  return <section>
    ...
    <Segmented label="成果物の種類" value={kind} onChange={setKind} options={[{ value: 'all', label: 'すべて' }, ...[...new Set(artifacts.map(item => kindLabel(item.kind)))].map(value => ({ value, label: value }))]} />
